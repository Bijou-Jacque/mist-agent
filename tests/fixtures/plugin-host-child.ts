...
import { RECOVERY_KEYS, fixturePlugin } from "./recoverable-plugin.ts";
...
const moduleRef = moduleRefFromSource(readFileSync(fixturePath));
...
const activation = {
  ...
  config: { enabled: true, settings: { fixturePath } },
  env: {},
